...
<nav class="main-nav dark stick-fixed js-transparent small-height">
    <div class="full-wrapper relative clearfix">
        ...
        <div class="mobile-nav small-height"
        ...
        <div class="inner-nav desktop-nav">
            <ul class="clearlist scroll-nav local-scroll">
                <li class="active"><a
                      href="mailto:<?php print variable_get('site_mail'); ?>"
                      style="height: 75px; line-height: 75px;"><i
                          class="fa fa-envelope"></i> <?php print variable_get('site_mail'); ?>
                    </a></li>
                <?php if (theme_get_setting('phone')): ?>
                    <li><a href="#" style="height: 75px; line-height: 75px;"><i
                              class="fa fa-phone"></i> <?php print theme_get_setting('phone'); ?>
                        </a></li>
                <?php endif; ?>
            </ul>
        </div>
